"""
Django settings for orange_union_dev_90087 project.
...
ROOT_URLCONF = 'orange_union_dev_90087.urls'
...
WSGI_APPLICATION = 'orange_union_dev_90087.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "orange_union_dev_90087 API",
    "DESCRIPTION": "API documentation for orange_union_dev_90087 App",
    "VERSION": "v1",
}
